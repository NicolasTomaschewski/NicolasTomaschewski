...
### 🔭 Stack de Observabilidade Distribuída

Implementação de observabilidade distribuída utilizando OpenTelemetry, Grafana, Prometheus e Jaeger em ambiente containerizado.

#### Destaques

* Coleta de métricas, logs e traces
* Distributed tracing
* Tail sampling e redução de overhead
...
### 🛰️ Simulação Computacional sobre Troca de Órbitas

Projeto de iniciação científica voltado para simulação computacional de dinâmicas orbitais de satélites artificiais.

#### Destaques

* Simulação física e matemática
* Python aplicado à computação científica
* Modelagem orbital
...
<div>
  <a href="mailto:nicolas.tomaschewski@gmail.com">
    <img src="https://img.shields.io/badge/-Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white">
  </a>

  <a href="https://www.linkedin.com/in/nicolastomaschewski/" target="_blank">
